 ...
 * Versión 3.5: Fix UX "Botón Agregar Canciones" + Cache Busting
 */
            ...
            ${tab === 'REPERTORIO' && html`
                <div className="space-y-4">
                    ${(form.repertorio || []).length === 0 && html`
                        <div onClick=${() => document.getElementById('song-search-input').focus()} className="bg-slate-900 border-2 border-dashed border-yellow-500/50 rounded-xl p-8 flex flex-col items-center justify-center cursor-pointer hover:bg-slate-800 transition group">
                            <div className="bg-yellow-600 rounded-full p-3 mb-3 shadow-lg group-hover:scale-110 transition">
                                <${Icon.BigPlus} />
                            </div>
                            <h3 className="text-white font-bold text-lg">AGREGAR CANCIONES</h3>
